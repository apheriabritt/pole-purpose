...
class SavedSets extends StatefulWidget {
  Function triggerRefetch;
  NotesModel currentNote;
  SavedSets({Key key, Function triggerRefetch, NotesModel currentNote})
      : super(key: key) {
  ...
  @override
  _SavedSetsState createState() => _SavedSetsState();
}

class _SavedSetsState extends State<SavedSets> {
  @override
  void initState() {
    super.initState();
    showHeader();
...
//
//                    Image.asset('${widget.currentNote.imageUrl}')
////                    Image.asset(widget.currentNote.imageUrl,
////
////                    ),
////
...
////
////                    ),
////                    Image.asset('images/cards/$randomCard1.png',height: 170,),
////                    Image.asset('images/cards/$randomCard2.png',height: 170,),
////                    Image.asset('images/cards/$randomCard3.png', height: 170,),
//
//
//
//
