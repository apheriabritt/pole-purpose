...
class PickACard extends StatefulWidget {
  @override
  _PickACardState createState() => _PickACardState();
}
...
class _PickACardState extends State<PickACard> {
                  ...
                  child: Hero(
                    ...
                    child: Container(
                      child: Swiper.children(
                        ...
                        scale: 1.0,
                        children: <Widget>[
                          CardWidget(context).selectCardNotReveled(1),
                          CardWidget(context).selectCardNotReveled(2),
                          CardWidget(context).selectCardNotReveled(3),
                          CardWidget(context).selectCardNotReveled(4),
                          CardWidget(context).selectCardNotReveled(5),
                          CardWidget(context).selectCardNotReveled(6),
                          CardWidget(context).selectCardNotReveled(7),
                          CardWidget(context).selectCardNotReveled(8),
                          CardWidget(context).selectCardNotReveled(9),
                          CardWidget(context).selectCardNotReveled(10),
                          CardWidget(context).selectCardNotReveled(11),
                          CardWidget(context).selectCardNotReveled(12),
                          CardWidget(context).selectCardNotReveled(13),
                          CardWidget(context).selectCardNotReveled(14),
                          CardWidget(context).selectCardNotReveled(15),
                          CardWidget(context).selectCardNotReveled(16),
                          CardWidget(context).selectCardNotReveled(17),
                          CardWidget(context).selectCardNotReveled(18),
                          CardWidget(context).selectCardNotReveled(19),
                          CardWidget(context).selectCardNotReveled(20),
                          CardWidget(context).selectCardNotReveled(21),
                          CardWidget(context).selectCardNotReveled(22),
                          CardWidget(context).selectCardNotReveled(23),
                          CardWidget(context).selectCardNotReveled(24),
                        ],
                      ),
                    ),
                  ),
