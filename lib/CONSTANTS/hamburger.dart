...
if (user.uid =='4iG0evlw96Su4wTLqHT6PlE0Sd22'||user.uid =='hW5IFcFO2dhx74iyv1of0DatC133'){
      ...
      void help(){
        ...
        Text('''
Long press on card to zoom in on any card 

Swipe left or right to browse, or tap “view all” to see the whole deck at a glance 

Save your favourite cards or card sets by tapping the heart icon 

Switch between viewing single cards and sets of three by tapping the card icon at the bottom left of the screen '''),
                        Padding(
                          padding: const EdgeInsets.all(8.0),
...
If you are new to dance making, spend some time on your own at the studio or at home if you have your own pole. This way, you can really hone in on what it is you enjoy exploring through your body. Make notes of the tasks you found most effective and the ones that were least effective. If you did find some tasks more stimulating, why? If you found other tasks less exciting, why? People learn and create in many different ways, so it is important that you follow the path that inspires you to move your body with complete enthusiasm.                        '''),
                        Padding(
                          padding: const EdgeInsets.all(8.0),
